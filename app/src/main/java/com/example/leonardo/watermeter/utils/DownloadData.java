                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (isFireHydrant) {
                            ...
                            //水表正常状态代表的value值
                            String normalValueStr = userInfoJson.getString("normal_value");
                            //获取阶梯水价
                            ...
                            detailDataList = ParseXml.getDetailData(inputStream, cbyf, bcList[i], ladder_price, waterMeterStateStr, normalValueStr, divideLimit);
                        }
