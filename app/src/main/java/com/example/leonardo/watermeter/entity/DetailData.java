...
public class DetailData extends LitePalSupport {
    ...
    private String t_mobile_phone2;//手机2
    ...
    private String t_new_phonenumber2;// 最新的手机号2
    ...
    private String sealNo;//铅封号 CC新增字段
    private String waterType;//水表类型:总分水表或者虚拟水表
    private String water_data_exception_status; //水表抄表异常flag  0_normal 1_exception
    private String normal_value; //水表正常状态所代表的value值

    public String getWater_data_exception_status() {
        return water_data_exception_status;
    }

    public void setWater_data_exception_status(String water_data_exception_status) {
        this.water_data_exception_status = water_data_exception_status;
    }
    ...
    public String getT_new_phonenumber2() {
        return t_new_phonenumber2;
    }

    public void setT_new_phonenumber2(String t_new_phonenumber2) {
        this.t_new_phonenumber2 = t_new_phonenumber2;
    }

    public String getT_mobile_phone2() {
        return t_mobile_phone2;
    }

    public void setT_mobile_phone2(String t_mobile_phone2) {
        this.t_mobile_phone2 = t_mobile_phone2;
    }
}
