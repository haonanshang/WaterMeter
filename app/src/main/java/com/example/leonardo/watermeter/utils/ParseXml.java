...
public class ParseXml {
     ...
     * @param normalValueStr     水表状态正常代表的value值
     * @param divideNumLimit
     * @return
     * @throws IOException
     * @throws XmlPullParserException
     */
    public static List getDetailData(InputStream is, String cbyf, String bch, String ladderPrice, String waterMeterStateStr,String normalValueStr, int divideNumLimit) throws IOException, XmlPullParserException {
                ...
                switch (type) {
                    case XmlPullParser.START_TAG:
                        if (xp.getName().equals("Table")) {
                            ...
                            detailData.setWater_data_exception_status("0"); // 0 代表水表状态异常
                            //写入水表正常状态所代表的value值
                            detailData.setNormal_value(normalValueStr);
                            //写入水表阶梯水价
                        ...
                        } else if (xp.getName().equals("seal_no")) {
                            detailData.setSealNo(xp.nextText());
                        }else if (xp.getName().equals("water_type")) {
                            String waterType=xp.nextText();
                            detailData.setWaterType(waterType);
                            if(waterType.equals("30")){
                                detailData.setIsChecked("0");
                                detailData.setIsUpload("1");
                            }
                        }
